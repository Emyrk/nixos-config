...
# Generated by Powerlevel10k configuration wizard on 2021-01-24 at 23:29 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$' # FROM ❯
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  # @Emyrk turned off wifi foreground
